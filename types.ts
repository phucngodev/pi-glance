export type SegmentId = "git" | "model" | "context" | "tokens" | "cost" | "speed";
...
import type { TokenSpeedEngine } from "./engine.ts";
...
export interface GlanceState {
  ...
  usage: UsageTotals;
  speed: number | null; // Current tokens-per-second (null when not streaming)
  speedEngine: TokenSpeedEngine | null; // Engine instance for real-time updates
  version: number;
}
